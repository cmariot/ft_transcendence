...
export default function Friends() {
  ...
  function displayStatus(status: string) {
    if (status === "Online") {
      ...
      return <div title="offline" className="friend-status-offline"></div>;
    } else if (status === "In_Game") {
      return <div title="in a game" className="friend-status-in-game"></div>;
    ...
    await axios
      ...
      .then((response) => {
        if (response.status === HttpStatusCode.NoContent) {
          ...
          chat.setCurrentChannelAdmins(response.data.data.channel_admins);
              ...
              {friends.map((friend, index) => (
                <li className="friend" key={index}>
                  <div className="div-friend-list">
                    <img
                      src={"/api/profile/" + friend["username"] + "/image"}
                      className="friend-profile-picture"
                      alt="Friend's avatar"
                    />
                    <div className="friend-middle-div">
                    ...
                    <ul className="friend-menu-ul">
                      ...
                      <li className="friend-menu-li">
                        <button
                          ...
                          onClick={() =>
                            directMessage(friend["username"], index)
                          }
                        >
                          Direct message
                        </button>
                      ...
                      <li className="friend-menu-li">
                        <button
                          className="friend-menu-button"
                          onClick={() => profile(friend["username"])}
                        >
                          Profile
                        </button>
                      </li>
                      <li className="friend-menu-li">
                        <button
                          className="friend-menu-button"
                          onClick={() =>
                            removeFriend(friend["username"], index)
                          }
                        >
                          Remove Friend
                        </button>
                      ...
                      <li className="friend-menu-li">
                        <button
                          className="friend-menu-button"
                          onClick={() => blockUser(friend["username"], index)}
                        >
                          Block
                        </button>
                      </li>
